...
FIELDS = ['subject_id', 'hadm_id', 'stay_id', 'starttime', 'endtime', 'itemid', 'value', 'valueuom', 'location', 'locationcategory']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/procedureevents.csv", "r", newline='', encoding="utf-8") as csvfile:
