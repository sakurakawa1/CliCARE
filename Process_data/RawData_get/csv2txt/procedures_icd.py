...
FIELDS = ['subject_id', 'hadm_id', 'seq_num', 'chartdate', 'icd_code', 'icd_version', 'long_title']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/procedures_icd.csv", "r", newline='', encoding="utf-8") as csvfile:
