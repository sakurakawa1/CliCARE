...
FIELDS = ['subject_id', 'hadm_id', 'emar_id', 'emar_seq', 'poe_id', 'pharmacy_id', 'charttime', 'medication']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/emar.csv", "r", newline='', encoding="utf-8") as csvfile:
