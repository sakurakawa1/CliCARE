...
FIELDS = ['subject_id', 'hadm_id', 'stay_id', 'first_careunit', 'last_careunit', 'intime', 'outtime', 'los']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/icustays.csv", "r", newline='', encoding="utf-8") as csvfile:
