...
FIELDS = ['subject_id', 'hadm_id', 'stay_id', 'charttime', 'itemid', 'value', 'valuenum', 'valueuom', 'label', 'category', 'unitname', 'lownormalvalue', 'highnormalvalue']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/chartevents.csv", "r", newline='', encoding="utf-8") as csvfile:
