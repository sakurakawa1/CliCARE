...
FIELDS = ['subject_id', 'hadm_id', 'itemid', 'charttime', 'value', 'valuenum', 'valueuom', 'flag', 'label', 'fluid', 'category']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/labevents.csv", "r", newline='', encoding="utf-8") as csvfile:
