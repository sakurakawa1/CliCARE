...
FIELDS = ['subject_id', 'hadm_id', 'drg_type', 'drg_code', 'description', 'drg_severity', 'drg_mortality']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/drgcodes.csv", "r", newline='', encoding="utf-8") as csvfile:
