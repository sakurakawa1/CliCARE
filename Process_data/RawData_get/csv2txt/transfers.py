...
FIELDS = ['subject_id', 'hadm_id', 'transfer_id', 'eventtype', 'careunit', 'intime', 'outtime']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/transfers.csv", "r", newline='', encoding="utf-8") as csvfile:
