...
FIELDS = ['subject_id', 'hadm_id', 'seq_num', 'icd_code', 'icd_version', 'long_title']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/diagnoses_icd.csv", "r", newline='', encoding="utf-8") as csvfile:
