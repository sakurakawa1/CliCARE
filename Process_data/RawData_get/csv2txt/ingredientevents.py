...
FIELDS = ['subject_id', 'hadm_id', 'stay_id', 'starttime', 'endtime', 'itemid','amount', 'amountuom', 'rate', 'rateuom']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/ingredientevents.csv", "r", newline='', encoding="utf-8") as csvfile:
