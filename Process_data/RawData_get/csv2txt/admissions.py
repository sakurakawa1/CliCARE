...
FIELDS = ["subject_id", "hadm_id", 'admittime', 'dischtime', 'deathtime', 'admission_type','admission_location', 'discharge_location', 'insurance', 'race', 'hospital_expire_flag']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/admissions.csv", "r", newline='', encoding="utf-8") as csvfile:
