...
FIELDS = ['subject_id', 'hadm_id', 'stay_id', 'charttime', 'itemid', 'value', 'valueuom']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/outputevents.csv", "r", newline='', encoding="utf-8") as csvfile:
