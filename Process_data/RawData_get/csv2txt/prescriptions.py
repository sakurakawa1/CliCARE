...
FIELDS = ['subject_id', 'hadm_id', 'pharmacy_id', 'poe_id', 'starttime', 'stoptime', 'drug', 'formulary_drug_cd', 'dose_val_rx', 'dose_unit_rx', 'route']

# read CSV
try:
    with open("/Cancer_MIMIC-IV/cancer_hosp/prescriptions.csv", "r", newline='', encoding="utf-8") as csvfile:
